...
class Premium_Multi_Scroll extends Widget_Base {
	...
	protected function render() {
		...
		foreach ( $templates as $index => $section ) {
			...
			$custom_navigation[] = $section['custom_navigation'];
		...
		<div <?php $this->print_render_attribute_string( 'multiscroll_wrapper' ); ?>>
			...
			<div <?php $this->print_render_attribute_string( 'multiscroll_inner' ); ?>>
				...
				<div <?php $this->print_render_attribute_string( 'left_side' ); ?>>
					<?php foreach ( $templates as $index => $section ) : ?>
						<div <?php $this->print_render_attribute_string( 'left_template' ); ?> <?php $this->print_render_attribute_string( 'left_section' . $index ); ?> data-navigation='<?php echo wp_json_encode( $custom_navigation ); ?>'>
							<?php
							if ( 'temp' === $section['left_content'] ) :
								...
								echo Helper_Functions::render_elementor_template( $template ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
									...
									?>
								<div <?php $this->print_render_attribute_string( 'left_side_text' ); ?>>
				...
				<div class="premium-multiscroll-fixed">
					...
					foreach ( $templates as $index => $section ) :
						...
						<?php if ( ! empty( $section['fixed_content_template'] ) ) : ?>
							<div <?php $this->print_render_attribute_string( 'fixed_content_template' . $index ); ?>  data-section-index="<?php echo esc_attr( $index ); ?>">
								<?php
