...
class Premium_Image_Accordion extends Widget_Base {
	...
	protected function register_controls() { // phpcs:ignore PSR2.Methods.MethodDeclaration.Underscore
		...
		$this->add_group_control(
			...
			array(
				'name'     => 'image_shadow',
				'selector' => '{{WRAPPER}} .premium-accordion-li',
			)
		);
	...
	protected function render() {
		...
		?>
			...
			<div <?php $this->print_render_attribute_string( 'accordion' ); ?>>
				<ul <?php $this->print_render_attribute_string( 'accordion_list' ); ?>>
					<?php
					foreach ( $settings['image_content'] as $index => $item ) :
						...
						<li <?php $this->print_render_attribute_string( $list_item_key ); ?>>
							...
							<?php if ( 'yes' === $item['link_switcher'] && 'yes' === $item['link_whole'] ) : ?>
								<a <?php $this->print_render_attribute_string( $item_link ); ?>></a>
							<?php endif ?>
							...
							<div <?php $this->print_render_attribute_string( 'overlay' ); ?>>
								<?php if ( 'yes' === $item['content_switcher'] ) : ?>
									<div <?php $this->print_render_attribute_string( 'content' ); ?>>
										...
										<?php if ( 'yes' === $item['link_switcher'] && 'yes' !== $item['link_whole'] ) : ?>
											<a class="premium-accordion-item-link-title" <?php $this->print_render_attribute_string( $item_link ); ?>>
