...
class Premium_Site_Logo extends Widget_Base {
	...
	protected function render() {
		...
		<?php endif; ?>
			...
			<div class="premium-site-logo-wrapper">
				<div <?php $this->print_render_attribute_string( 'logo_img_container' ); ?>>
	...
	public function get_logo_img_html( $settings ) {
		...
		if ( 'img' === $type ) {
			...
			?>
				<div <?php $this->print_render_attribute_string( 'lottie_wrapper' ); ?>></div>
			<?php
		} else {
			...
			if ( ! is_wp_error( $svg_code ) ) :
				...
				?>
					<div <?php $this->print_render_attribute_string( 'svg_container' ); ?> >
					<?php
					if ( ! empty( $settings['svg_code'] ) ) :
