...
class Premium_Tabs extends Widget_Base {
	...
	protected function register_controls() { // phpcs:ignore PSR2.Methods.MethodDeclaration.Underscore
		...
		$this->add_group_control(
			...
			array(
				...
				'selector'       => '{{WRAPPER}} .premium-tabs:not(.premium-tabs-style-circle):not(.premium-tabs-style-flip) .premium-tab-link, {{WRAPPER}} .premium-tabs-style-flip .premium-tabs-nav .premium-tabs-nav-list-item, {{WRAPPER}} .premium-tabs-style-circle .premium-tabs-nav li::before, {{WRAPPER}} .premium-tabs-style-tzoid .premium-tab-link::after',
				'condition'      => array(
		...
		$this->add_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .premium-tabs:not(.premium-tabs-style-circle):not(.premium-tabs-style-flip) .premium-tab-link, {{WRAPPER}} .premium-tabs-style-flip .premium-tabs-nav .premium-tabs-nav-list-item, {{WRAPPER}} .premium-tabs-style-circle .premium-tabs-nav li::before, {{WRAPPER}} .premium-tabs-style-tzoid .premium-tab-link::after' => 'border-radius: {{SIZE}}{{UNIT}};',
				),
				'condition'  => array(
					'premium_tab_style_selected!' => 'style4',
				),
		...
		$this->add_group_control(
			...
			array(
				...
				'fields_options' => array(
					'border' => array(
						'selectors' => array(
							'{{WRAPPER}}:not(.premium-tabs__background-yes) .premium-tabs:not(.premium-tabs-style-flip) .premium-tabs-nav-list li.tab-current .premium-tab-link, {{WRAPPER}} .premium-tabs-style-flip .premium-tabs-nav-list li.tab-current, {{WRAPPER}}.premium-tabs__background-yes .premium-tabs-nav-list::before' => 'border-style: {{VALUE}}',
						),
					),
					'width'  => array(
						'selectors' => array(
							'{{WRAPPER}}:not(.premium-tabs__background-yes) .premium-tabs:not(.premium-tabs-style-flip) .premium-tabs-nav-list li.tab-current .premium-tab-link' => 'border-width: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px',
							'{{WRAPPER}} .premium-tabs-style-flip .premium-tabs-nav-list li.tab-current' => 'border-width: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px',
					...
					'color'  => array(
						'selectors' => array(
							'{{WRAPPER}}:not(.premium-tabs__background-yes) .premium-tabs:not(.premium-tabs-style-flip) .premium-tabs-nav-list li.tab-current .premium-tab-link' => 'border-color: {{VALUE}}',
							'{{WRAPPER}} .premium-tabs-style-flip .premium-tabs-nav-list li.tab-current' => 'border-color: {{VALUE}}',
		...
		$this->add_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}}:not(.premium-tabs__background-yes) .premium-tabs:not(.premium-tabs-style-flip) .premium-tabs-nav-list li.tab-current .premium-tab-link, {{WRAPPER}} .premium-tabs-style-flip .premium-tabs-nav-list li.tab-current, {{WRAPPER}}.premium-tabs__background-yes .premium-tabs-nav-list::before' => 'border-radius: {{SIZE}}{{UNIT}};',
				),
				'condition'  => array(
					'premium_tab_style_selected' => array( 'style1', 'style3' ),
				),
	...
	protected function render() {
		...
		foreach ( $tabs as $index => $tab ) {
			$custom_nav[] = $tab['custom_tab_navigation'];
		}
		...
		?>
			...
			<div <?php $this->print_render_attribute_string( 'tabs_wrap' ); ?>>
				<div <?php $this->print_render_attribute_string( 'tabs_nav' ); ?>>
					<ul <?php $this->print_render_attribute_string( 'tabs_list' ); ?>>
						<?php
						foreach ( $tabs as $index => $tab ) {
							...
							?>
							<li <?php $this->print_render_attribute_string( $list_key ); ?>>
								<a <?php $this->print_render_attribute_string( $tab_key ); ?>>
									...
									if ( 'yes' === $tab['premium_tabs_icon_switcher'] ) {
										if ( 'icon' === $tab['icon_type'] ) {
											...
											?>
												<div <?php $this->print_render_attribute_string( $icon_key ); ?>></div>
											<?php
										}
									}
				...
				<div <?php $this->print_render_attribute_string( 'tabs_content' ); ?>>
					<?php
					foreach ( $tabs as $index => $tab ) :
