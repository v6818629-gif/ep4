...
class Premium_Instagram_Feed extends Widget_Base {
	...
	protected function register_controls() { // phpcs:ignore PSR2.Methods.MethodDeclaration.Underscore
		...
		$this->add_control(
			'access_token_notice',
			array(
				'raw'             => __( 'Please note that it takes 20-30 seconds before the token is generated and added to the Access Token field.', 'premium-addons-pro' ),
				'type'            => Controls_Manager::RAW_HTML,
	...
	protected function render() {
		...
		<?php else : ?>
			<div <?php $this->print_render_attribute_string( 'instagram' ); ?>>
				<div <?php $this->print_render_attribute_string( 'instagram_container' ); ?>></div>
