...
class Premium_Flipbox extends Widget_Base {
	...
	protected function register_controls() { // phpcs:ignore PSR2.Methods.MethodDeclaration.Underscore
		...
		$this->add_control(
			...
			array(
				...
				'options'     => array(
					...
					'image'     => array(
						'title' => __( 'Custom Image', 'premium-addons-pro' ),
		...
		$this->add_control(
			...
			array(
				...
				'options'     => array(
					'icon'      => array(
						'title' => __( 'Font Awesome Icon', 'premium-addons-pro' ),
						'icon'  => 'divider-type-icon',
					),
					'image'     => array(
						'title' => __( 'Custom Image', 'premium-addons-pro' ),
	...
	<div <?php $this->print_render_attribute_string( 'container' ); ?>>
		<div <?php $this->print_render_attribute_string( 'front' ); ?>>
					...
					<div class="premium-flip-text-wrapper">
						<?php if ( 'yes' === $settings['premium_flip_icon_fa_switcher'] ) : ?>
							...
							elseif ( 'svg' === $front_icon ) :
								?>
								<div <?php $this->print_render_attribute_string( 'front_icon' ); ?>>
									<?php $this->print_unescaped_setting( 'front_custom_svg' ); ?>
								</div>
								<?php
							elseif ( 'image' === $front_icon ) :
								?>
								<img <?php $this->print_render_attribute_string( 'front_image' ); ?>>
							<?php elseif ( 'animation' === $front_icon ) : ?>
								<div <?php $this->print_render_attribute_string( 'front_lottie' ); ?>></div>
							<?php endif; ?>
						<?php endif; ?>
		...
		<div <?php $this->print_render_attribute_string( 'back' ); ?>>
					...
					<div class="premium-flip-back-text-wrapper">
						...
						<?php if ( 'yes' === $settings['premium_flip_back_icon_fa_switcher'] ) : ?>
							...
							elseif ( 'svg' === $back_icon ) :
								?>
								<div <?php $this->print_render_attribute_string( 'back_icon' ); ?>>
									<?php $this->print_unescaped_setting( 'back_custom_svg' ); ?>
								</div>
							<?php elseif ( 'image' === $back_icon ) : ?>
								<img <?php $this->print_render_attribute_string( 'back_image' ); ?>>
							<?php else : ?>
								<div <?php $this->print_render_attribute_string( 'back_lottie' ); ?>></div>
							<?php endif; ?>
						<?php endif; ?>
