...
5. [Premium Content Toggle](https://premiumaddons.com/elementor-content-toggle-widget/)
...
- Fixed: Duplicate CSS rules applied.

= 2.9.63 =

- Fixed: Anchoring section in a page with Horizontal Scroll not working.
- Fixed: Animated Gradient addon not working in some cases.

= 2.9.62 =

- Tweak: Minor improvements in Global Badge addon for better usability.

= 2.9.61 =

- New: Added CSS Selector option in Global Badge addon to display badges on custom elements.
- New: Added Display Per Item option in Global Badge addon for listing widgets.
- New: Added Title Vertical Alignment option in Icon Box widget.
- Tweak: Added Overflow option in Icon Box widget for better compatibility with Global Badge addon.
- Tweak: Added Border Radius option for Ribbon style badge in Global Badge addon.
- Tweak: Added a waiting time notice in Instagram Feed widget.
- Tweak: Improved content labels in Content Toggle widget.
- Tweak: Lowered the minimum value of the Size control in Content Toggle widget.
- Fixed: Badge banner top position in Global Badge addon.
- Fixed: Vertical offset not working on all badges in Global Badge addon.
- Fixed: Text decoration not inheriting text color in Global Badge addon.
- Fixed: "undefined" text shown when Image URL is empty in Global Badge addon.
- Fixed: Animated Gradient option applied to all child badges in Global Badge addon.
- Fixed: Per-item badges not working with Load More, Pagination and Load on Scroll options.
- Fixed: Z-index not working on custom CSS selector badges in Global Badge addon.
- Fixed: Conflict between Global Badge addon and Pricing Table widget Lottie icon.
- Fixed: Button alignment not working when position is set to outside in Unfold widget.
- Fixed: Magic Scroll not working with widgets inside Elementor V4 Flexbox container.
- Fixed: Content height not working on nested content in Content Toggle widget.

= 2.9.60 =

- New: Content Toggle widget rebuilt - [here](https://premiumaddons.com/elementor-content-toggle-widget/).
- Tweak: Code refactored for better performance and security.

= 2.9.59 =

- Tweak: Added Box Shadow control for images in Image Accordion.
- Fixed: Border Radius not applied on Flipped style Tabs widget.
- Fixed: Default width not applied on Bookmark type badge.
