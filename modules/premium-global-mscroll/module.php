...
class Module extends Module_Base {
	...
	private function add_helpful_information( $element ) {
		...
		$docs = array(
			...
			'https://www.youtube.com/watch?v=yLO51pGeL-c&list=PLLpZVOYpMtTBW1CmxHy71R7Oq6FS8uh3D' => __( 'Video tutorials »', 'premium-addons-pro' ),
	...
	public function before_render( $element ) {
		...
		if ( 'yes' === $element->get_settings_for_display( 'premium_mscroll_switcher' ) && isset( $settings['premium_mscroll_repeater'] ) ) {
			...
			if ( 'widget' === $type && \Elementor\Plugin::instance()->editor->is_edit_mode() ) {
				...
				?>
				<div <?php $element->print_render_attribute_string( 'mscroll' . $id ); ?>></div>
				<?php
			}
		}
	}
