    ...
    var PAPROWidgetsEditor = {
        ...
        onSectionActivate: function (sectionName, elementorEditor) {
            ...
            var editModelView = elementorEditor.getOption('editedElementView'),
                ...
                widgetType = editModel.get('widgetType'),
                elType = editModel.get('elType'),
                listingWidgets = ['premium-addon-blog', 'premium-smart-post-listing', 'premium-notifications', 'premium-woo-products'];

            if ('section_premium_badge' === sectionName) {

                var isListingWidget = 'widget' === elType && listingWidgets.includes(widgetType);

                if (isListingWidget) {

                    jQuery('.elementor-control-pa_badge_per_item, .elementor-control-pa_badge_per_item_source').addClass('papro-badge-listing-widget');
                } else {
                    jQuery('.elementor-control-pa_badge_per_item, .elementor-control-pa_badge_per_item_source').removeClass('papro-badge-listing-widget');
                }
            }
            ...
            if ('premium-img-layers-addon' === widgetType || 'premium-addon-image-hotspots' === widgetType) {
        ...
        reRender: function (currentDevice) {

            if (currentDevice === "desktop")
                currentDevice = '';

            $(".elementor-control-premium_img_layers_hor_position_" + currentDevice).find("input").trigger("input");
